"""Проверки управления площадками и раскрытия дополнительной информации участника."""
...
def test_schedule_columns_never_wrap_and_management_controls_are_present() -> None:
...
def test_organizer_layout_is_centered_with_explicit_wide_workspaces() -> None:
    ...
    schedule_css = (root / "schedule.css").read_text(encoding="utf-8")
